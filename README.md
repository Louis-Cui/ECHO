...
> 基于 SenseVoiceSmall + CosyVoice + LangGraph 的情感陪伴数字人后端

---

## 📖 简介

**数字人情感陪伴系统**是一个多模态情感感知的 AI 陪伴后端系统，能够：
...
- 自然语音生成 (inference_sft / inference_zero_shot)
- 情绪驱动的语速/音调调节
...
请参见 [requirements.txt](requirements.txt) 完整列表。
...
│   ├── asr/
│   │   ├── __init__.py
│   │   └── sensevoice.py          # 语音识别 + SER
│   ├── tts/
│   │   ├── __init__.py
│   │   └── cosyvoice_tts.py       # 语音合成
│   ├── emotion/
│   │   ├── __init__.py
│   │   ├── fer.py                 # 面部情绪识别
│   │   └── fusion.py              # 多模态情绪融合
